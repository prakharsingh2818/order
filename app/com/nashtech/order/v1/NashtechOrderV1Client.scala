 ...
 * apibuilder 0.15.33 app.apibuilder.io/nashtech/order/latest/play_2_8_client
 */
...
package com.nashtech.order.v1.models {
  ...
  package object json {
    ...
    implicit def jsonReadsOrderError: play.api.libs.json.Reads[Error] = {
      for {
        code <- (__ \ "code").read[String]
        message <- (__ \ "message").read[String]
        details <- (__ \ "details").read[String]
      } yield Error(code, message, details)
    }
    ...
    def jsObjectError(obj: com.nashtech.order.v1.models.Error): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        ...
        "details" -> play.api.libs.json.JsString(obj.details)
      )
    }
...
package com.nashtech.order.v1 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder 0.15.33 app.apibuilder.io/nashtech/order/latest/play_2_8_client"
    val Version = "1.0.1"
    val VersionMajor = 1
    ...
    object Orders extends Orders {
      ...
      override def post(
        ...
        _executeRequest("POST", s"/${play.utils.UriEncoding.encodePathSegment(merchantId, "UTF-8")}/orders", body = Some(payload), requestHeaders = requestHeaders).map {
          ...
          case r if r.status == 201 => _root_.com.nashtech.order.v1.Client.parseJson("com.nashtech.order.v1.models.Orderform", r, _.validate[com.nashtech.order.v1.models.Orderform])
          case r if r.status == 404 => throw com.nashtech.order.v1.errors.UnitResponse(r.status)
          case r if r.status == 422 => throw com.nashtech.order.v1.errors.ErrorsResponse(r)
          case r => throw com.nashtech.order.v1.errors.FailedRequest(r.status, s"Unsupported response code[${r.status}]. Expected: 200, 201, 404, 422")
        }
      }
    }
  ...
  package errors {
    ...
    final case class ErrorsResponse(
      ...
      lazy val errors = _root_.com.nashtech.order.v1.Client.parseJson("Seq[com.nashtech.order.v1.models.Error]", response, _.validate[Seq[com.nashtech.order.v1.models.Error]])
    }
